...
export function Sheet({ open, onClose, children, title }: SheetProps) {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "fixed inset-y-0 right-0 z-50 flex w-full max-w-md flex-col bg-white shadow-xl transition-transform duration-300 dark:bg-slate-900 dark:border-l dark:border-slate-800",
