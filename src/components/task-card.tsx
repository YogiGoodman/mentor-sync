      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex items-center gap-1">
          ...
          <button
            ...
            className="relative rounded-md p-1.5 text-slate-300 transition-colors hover:bg-slate-100 hover:text-slate-600"
            title="Comments"
          >
            <MessageCircle className="h-4 w-4" />
            {task.comment_count > 0 && (
              <span className="absolute -right-0.5 -top-0.5 flex h-4 w-4 items-center justify-center rounded-full bg-slate-700 text-[10px] font-medium text-white">
                {task.comment_count}
              </span>
            )}
          </button>
