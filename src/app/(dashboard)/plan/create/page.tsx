      ...
      >
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              className="mt-1 block w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-slate-900 focus:border-slate-500 focus:outline-none focus:ring-1 focus:ring-slate-500 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100 dark:focus:border-emerald-500 dark:focus:ring-emerald-500"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="mt-1 block w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-slate-900 focus:border-slate-500 focus:outline-none focus:ring-1 focus:ring-slate-500 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100 dark:focus:border-emerald-500 dark:focus:ring-emerald-500 dark:[color-scheme:dark]"
            />
          </div>
        </div>
        ...
        <div className="space-y-3 border-t border-slate-100 pt-5 dark:border-slate-800">
          ...
          {phases.map((phase, pi) => (
            <div
              key={pi}
              className="rounded-lg border border-slate-200 bg-slate-50/50 p-3 space-y-2 dark:border-slate-800 dark:bg-slate-800/40"
            >
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  className="flex-1 rounded-md border border-slate-300 bg-white px-2.5 py-1 text-sm text-slate-900 placeholder-slate-400 focus:border-slate-500 focus:outline-none focus:ring-1 focus:ring-slate-500 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100 dark:placeholder-slate-500 dark:focus:border-emerald-500 dark:focus:ring-emerald-500"
                />
                <button
                  type="button"
              ...
              {phase.tasks.length > 0 && (
                <div className="space-y-1">
                  {phase.tasks.map((t, ti) => (
                    <div
                      key={ti}
                      className="flex items-center gap-2 rounded-md bg-white px-2.5 py-1.5 text-sm dark:bg-slate-900"
                    >
